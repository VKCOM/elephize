...
export class CommonjsExternalModule extends CommonjsModule {
  ...
  public constructor(
    ...
    super(className + 'CjsWrapper', sourceFileName, targetFileName, _namespaces, serverFilesRoot, builtinsPath, log, originalIdentName, ancestorModule);
  }
  ...
  public generateContent() {
    ...
    const implementationClassName = `\\${this._phpStruct.getNamespace()}\\${this._phpStruct.getClassName()}`;
