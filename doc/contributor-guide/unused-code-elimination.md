### Вкратце о принципах работы удаления неиспользуемого кода
...
Таким образом, архитектурно в слое удаления неиспользуемого кода имеется две основных сущности:
- Граф использований
...
__алгоритм уничтожения неиспользуемого кода__ как обыкновенный обход графа в глубину начиная с глобальной терминальной вершины. 
После обхода мы можем достоверно судить используется ли идентификатор по наличию отметки об обходе в соответствующей вершине.
